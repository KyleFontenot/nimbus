<script lang="ts">
  interface MetaTagsProps {
    ...
    twitter?: TwitterSummary | TwitterSummaryLargeImage | TwitterApp | TwitterPlayer
    facebook?: Facebook
    openGraph?: OpenGraph
  ...
  interface TwitterSummary extends Twitter {
    cardType: 'summary'
  }
  interface TwitterSummaryLargeImage extends Twitter {
    cardType: 'summary_large_image'
  }
  interface TwitterApp extends Twitter {
    cardType: 'app'
    appIdIphone?: string
    appUrlIphone?: string
    appIdIpad?: string
  ...
  interface TwitterPlayer extends Twitter {
    cardType: 'player'
    url: string
    playerWidth: number
    playerHeight: number
  ...
  {#if twitter}
    {#if twitter.cardType === 'summary'}
      ...
      {#if twitter.image}
        ...
        {/if}
      {/if}
    {:else if twitter.cardType === 'summary_large_image'}
      <meta name="twitter:card" content="summary" />
      {#if twitter.site}
        <meta name="twitter:site" content={twitter.site} />
      {/if}
      ...
      {#if twitter.image}
        ...
        {/if}
      {/if}
    {:else if twitter.cardType === 'player'}
